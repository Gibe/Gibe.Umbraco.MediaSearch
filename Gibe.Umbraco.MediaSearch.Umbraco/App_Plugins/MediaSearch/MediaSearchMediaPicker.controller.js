function mediaSearchMediaPickerController($scope, umbRequestHelper, $log, $http, $document, entityResource, mediaHelper, localizationService, $location, $timeout, dialogService) {
...
angular.module("umbraco").controller("Gibe.Umbraco.MediaSearch.MediaPicker", mediaSearchMediaPickerController);